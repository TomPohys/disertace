...
char s_bat[2], s_s_temp[2], s_s_hum[2], s_ec51[2], s_ec52[2], s_ec[2], s_ec_temp[2], s_pluv[2], s_pluv_last_hour[2], s_rest_decimal[2];
...
void setup(){
  ...
  xbee802.setOwnNetAddress(0x00,0x02);
    ...
    if(intFlag & RTC_INT)
      {
        ...
        */
        ...
        // +50 aby teplota -50 byla + a +50 byla 100
...
{  
  ...
  //////////////////////////////////////////////////////////////
    ...
    */
    USB.println(read_analog6);
    USB.println(read_analog7);
    sensor_volts6 = (float(read_analog6) * 440 / 1023);
    sensor_volts7 = (float(read_analog7) * 440 / 1023);
  ...
  // DFROBOT - EC, DS18B20
    ...
    */
    // 3.5ml na preklopeni
    // uprava knihovny - vrací počet překlopení
    pluviometer1 = SensorAgrv20.readPluviometerCurrent();// / 0.2794 * 0.175;
    pluviometer2 = SensorAgrv20.readPluviometerHour();// / 0.2794 * 0.175;
