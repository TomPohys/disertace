...
int VWC6_int;
int VWC7_int;
int pluviometer1_int;
int  pluviometer2_int;
float sensiron_temp;
float sensiron_hum;
    ...
    if(intFlag & RTC_INT)
      {
        ...
        frame.addSensor(SENSOR_SOIL1, VWC6_int);
        frame.addSensor(SENSOR_SOIL2, VWC7_int);
        //frame.addSensor(SENSOR_LW, ECcurrent);
        frame.addSensor(SENSOR_TCA, temperature);
        frame.addSensor(SENSOR_PLV1, pluviometer1_int);
        frame.addSensor(SENSOR_PLV2, pluviometer2_int);
...
{  
  ...
  //////////////////////////////////////////////////////////////
    ...
    */
    ...
    sensor_volts6 = (float(read_analog6) * 465 / 1023);
    sensor_volts7 = (float(read_analog7) * 465 / 1023);
    ...
    char str_VWC6[2];
    Utils.float2String (VWC6, str_VWC6, 0);
    
    VWC6_int = atol(str_VWC6);
    USB.println(VWC6_int);
    
    char str_VWC7[2];
    Utils.float2String (VWC7, str_VWC7, 0);
    
    VWC7_int = atol(str_VWC7);
    USB.println(VWC7_int);
    /*
    USB.print(" EC_5_6 ");
    USB.println(EC_5_6);
  ...
  // DFROBOT - EC, DS18B20
    ...
    */
    ...
    // jen počet překlopení - upravena knihovna
    pluviometer1 = SensorAgrv20.readPluviometerCurrent();

    //pluviometer1 = pluv_correct; 
    USB.print(pluviometer1);
    pluviometer2 = SensorAgrv20.readPluviometerHour();
    
    char str_pluviometer1[3];
    Utils.float2String (pluviometer1, str_pluviometer1, 0);
    
    pluviometer1_int = atol(str_pluviometer1);
    USB.println(pluviometer1_int);
    
    char str_pluviometer2[3];
    Utils.float2String (pluviometer2, str_pluviometer2, 0);
    
    pluviometer2_int = atol(str_pluviometer2);
    USB.println(pluviometer1_int);
